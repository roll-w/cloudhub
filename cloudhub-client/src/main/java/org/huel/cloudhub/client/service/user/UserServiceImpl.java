...
import org.huel.cloudhub.client.event.user.login.OnLoginNewLocationEvent;
import org.huel.cloudhub.client.event.user.register.OnRegistrationCompleteEvent;
