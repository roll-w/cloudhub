 ...
 */
@Deprecated
public class ContainerWriter2 implements Closeable {
    ...
    private ContainerModifier containerModifier;
    ...
    public ContainerWriter2(Container container,
                            ContainerAllocator containerAllocator,
                            ContainerModifier modifier) throws IOException {
    ...
    public Container requireUpdate() throws MetaException, IOException {
        ...
        containerModifier.updatesContainerMetadata(updateContainer);
        updates = true;
