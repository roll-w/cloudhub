...
public enum UserGroupErrorCode implements ErrorCode, ErrorCodeFinder, ErrorCodeMessageProvider {
    ...
    ERROR_GROUP_NAME_EXIST("B3602", 400),
    ERROR_GROUP_NAME_NOT_EXIST("B3603", 400),
    ERROR_GROUP_NAME_INVALID("B3604", 400),
    ERROR_GROUP_DESCRIPTION_INVALID("B3605", 400),
    ERROR_GROUP_SETTINGS_INVALID("B3606", 400),
    ERROR_GROUP_SETTINGS_KEY_INVALID("B3607", 400),
    ERROR_GROUP_SETTINGS_VALUE_INVALID("B3608", 400),
